...
const features = [
  ...
  },
  {
    icon: Clock,
    title: "2 Min",
    subtitle: "Per Shift Log",
    description: "Foremen log full production data in under 2 minutes",
    accent: "#10b981",
  },
  {
    icon: ShieldCheck,
    ...
    description: "Material savings through data-driven process standardization",
    accent: "#f59e0b",
  },
  {
    icon: Brain,
