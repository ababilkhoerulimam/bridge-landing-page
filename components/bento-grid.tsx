...
const features = [
  {
    ...
    description: "Log 100% offline on factory floor, auto-syncs when connected.",
    accent: "#3b82f6",
  },
  {
    icon: Clock,
    title: "2 Min",
    subtitle: "Per Shift Logging",
    description: "Complete shift logs in under 2 minutes with zero paper.",
    accent: "#10b981",
  },
  {
    icon: ShieldCheck,
    ...
    description: "Material COGS savings through standardized recipe parameters.",
    accent: "#f59e0b",
  },
  {
    icon: CloudUpload,
    ...
    description: "Local SQLite buffer auto-updates Owner Dashboard on signal.",
    accent: "#3b82f6",
  },
]
...
export function BentoGrid() {
  ...
  return (
    <section id="features" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#3b82f6] text-[10px] tracking-[0.3em] uppercase"
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#3b82f6] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
